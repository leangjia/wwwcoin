...
#if defined(NDEBUG)
# error "Wwwcoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Wwwcoin Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s WWW additional fees, %d delta bytes\n",
...
CAmount GetBlockSubsidy(int nHeight, const Consensus::Params& consensusParams)
{
    ...
    //wwwcoin in nHeight 1 reward to team
    if (nHeight == 1) {
        nSubsidy = 34000000 * COIN;
    }
